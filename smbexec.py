#!/usr/bin/python
#
# NOTE: Modified version of smbexec.py to drop GUIDs instead of BTOB and other minor  modifications (@0rbz_)
#
...
BATCH_FILENAME  = str(uuid.uuid4()) + '.bat'
SMBSERVER_DIR   = str(uuid.uuid4())
DUMMY_SHARE     = str(uuid.uuid4())
...
class CMDEXEC:
    ...
    def __init__(self, protocols=None,
        ...
        self.__serviceName = str(uuid.uuid4())
